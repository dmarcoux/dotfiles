  ...
  environment.systemPackages = with pkgs; [(
    vim_configurable.customize {
      ...
      vimrcConfig.plug.plugins = with pkgs.vimPlugins; [
        ...
        # Autocompletion engine from VSCode
      ...
      vimrcConfig.customRC = ''
        ...
        " After typing, time in milliseconds before updating the interface
        set updatetime=300
        ...
        " Use Enter to confirm completion, `<C-g>u` means break undo chain at current position. Coc only does snippet and additional edit on confirm.
